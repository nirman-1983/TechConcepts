...
public class TopicsController : ControllerBase
{
    ...
    /// </summary>
    [HttpGet("{id}")]
    public async Task<ActionResult<GetTopicResponse>> GetTopic(int id)
    {
    ...
    public async Task<ActionResult<GetTopicsResponse>> GetTopicsBySubject(int subjectId)
    {
        var query = new GetTopicsBySubjectIdQuery(subjectId);
        var result = await _mediator.Send(query);
        return Ok(result);
    }
